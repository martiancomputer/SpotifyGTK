...
| GTK4 UI shell (`gui_main.c`) | 🟡 Desktop-style GTK4 shell with header search, persistent playback bar, URI/track-ID selection, live connection/buffering/playing stages, and pause/resume output; queue and seek remain to be integrated. |
